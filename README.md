...
This program is a sample AWS Lambda function for Alexa. For information about writing AWS Lambda functions, refer to their [site](http://aws.amazon.com/lambda), which demonstrates how to write a skill for the Amazon Echo using the Alexa SDK. This simple sample has no external dependencies or session management, and shows the most basic example of how to create a Lambda function for handling Alexa Skill requests. 
